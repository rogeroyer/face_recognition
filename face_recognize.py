...
img_path = 'E:/comtemporary/face_recognition/image/FaceDB_orl/'              # 图片路径
...
class FaceRecognize(object):
    ...
    def divide(self, rate=0.7, shuffle=False):
        ...
        :param rate:divided rate
        :param shuffle:whether shuffle data set
    ...
    def store_model(self, sess, epoch):
        absolute_path = 'E:/comtemporary/face_recognition/'
...
if __name__ == '__main__':
    ...
    # face.run()
    test_sample = face.load_predict_sample('image/FaceDB_orl/001/10.png')
